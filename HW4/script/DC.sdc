...
create_clock -name clk -period 14.2 [get_ports clk]
...
set_input_delay  -max  7.1  -clock clk [remove_from_collection [all_inputs] [get_ports clk]]
set_input_delay  -min  0.0  -clock clk [remove_from_collection [all_inputs] [get_ports clk]]
set_output_delay -max  7.1  -clock clk [all_outputs]
