...
create_clock -name clk -period 12.4 [get_ports clk]
...
set_input_delay  -max 6.2  -clock clk [remove_from_collection [all_inputs] [get_ports clk]]
set_input_delay  -min  0.0  -clock clk [remove_from_collection [all_inputs] [get_ports clk]]
set_output_delay -max 6.2  -clock clk [all_outputs]
